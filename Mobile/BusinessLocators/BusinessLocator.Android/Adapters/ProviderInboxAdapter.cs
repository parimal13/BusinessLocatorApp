...
{
    class ProviderInboxAdapter : BaseAdapter<Chat>
    {

        Activity context;
        List<Chat> list;

        public ProviderInboxAdapter(Activity _context, List<Chat> _list) : base()
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (view == null)
                view = context.LayoutInflater.Inflate(Resource.Layout.ProviderInboxItem, parent, false);
